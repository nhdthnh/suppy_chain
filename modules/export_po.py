"""
modules/export_po.py

Điền sản phẩm vào template Excel — sheet PO + sheet CI.
Sử dụng config/export_po.json để render động và dễ bảo trì.
"""
...
_CONFIG_PATH = os.path.join(_HERE, "..", "config", "export_po.json")

# ── Default Fallback Config ───────────────────────────────────
# Giúp code luôn chạy an toàn ngay cả khi file JSON cấu hình bị xóa/lỗi
_DEFAULT_CONFIG = {
  "sheets": [
    {
      "name": "PO",
